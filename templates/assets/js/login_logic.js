...
const button = document.querySelector('#loginkey');
const loginfield = document.querySelector('#login');
const passwordfield = document.querySelector('#password');
const loginkey = document.querySelector('#loginkey');

const wrongpasswordtext = document.querySelector('#wrongpasswordtext');
wrongpasswordtext


button.addEventListener('click', () => {

    var data = { login: loginfield.value, password: CryptoJS.SHA256(passwordfield.value).toString() };
    ...
    fetch('http://127.0.0.1:5000/login', {
        ...
        .then(jsonData => {
            if (jsonData == "None") {
                ...
                console.log("got id " + jsonData);
                // setSessionValue(jsonData)
...
function setSessionValue(id) {
    ...
    fetch('http://127.0.0.1:5000/set_session_data', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
